...
% \title{Ricerca del dibarione d*(2380) all'LHC con l'Esperimento ALICE}
\subtitle{Ricerca del dibarione \dst all'LHC con l'Esperimento ALICE}
\date{19 Ottobre 2018}
\author{\texttt{Pietro Fecchio}}
\institute{Università degli Studi di Torino \par \small{Dipartimento di Fisica}}

\hypersetup{
pdfauthor = {Pietro Fecchio},
...
The logo on the title side, should be replaced with your own.  
\vspace{1cm}
\begin{figure}
